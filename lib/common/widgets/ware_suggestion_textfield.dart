...
class WareSuggestionTextField extends StatelessWidget {
  ...
  final Function(RawWare val) onSuggestionSelected;

  final bool validate;
  final bool enable;

  Future<List<RawWare>> suggestion(String query) async {
    return HiveBoxes.getRawWare().values.map((e) => e).where((element) {
